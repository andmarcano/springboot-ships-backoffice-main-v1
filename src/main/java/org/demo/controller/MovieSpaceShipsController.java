...
import org.demo.service.CreateShipsProducer;
...
public class MovieSpaceShipsController {
    ...
    private final CreateShipsProducer createShipsProducer;
    ...
    @PostMapping(path = "/space-ships/producer")
    public ResponseEntity<?> createOrder(@RequestBody MovieSpaceShipsDto order) throws ExecutionException, InterruptedException {
        createShipsProducer.sendCreateOrderEvent(order);
